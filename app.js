/* 313A Exam Simulator, Application Logic */

const ACCESS_CODE  = "313A9000";
const EXAM_SECONDS = 14400;
const PASSING_PCT  = 70;
const STORAGE_KEY  = "313a_exam_state_v1";
...
const DOMAIN_LABELS = {"common_occupational_skills": "Common Occupational Skills", "routine_trade_activities": "Routine Trade Activities", "installation_planning": "Installation Planning", "installation": "Installation", "commissioning": "Commissioning", "maintenance_and_service": "Maintenance and Service"};  // maps domain key -> human-readable label for display
